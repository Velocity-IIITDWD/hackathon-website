...
const EventNavbar = ({events, eventId, onClick}: EventNavBarProps) => {
    return (
        <div
            className="grid grid-cols-6 md:flex p-2 w-full h-fit gap-4 sm:gap-8 lg:gap-24 items-stretch place-items-center justify-center mx-2 px-4 z-[2]">
            {events.map((event) => {
                ...
                return (
                    ...
                    >
                        <div
                            className="flex flex-col items-center w-full justify-center h-full bg-gradient-carousel rounded-lg  ">
                            <div
                                className={
