...
const CarouselBody = ({event, orbitsRef, planetsRef}: CarouselBodyProps) => {
    return (
        <div className="relative flex w-full items-center justify-center [&_*]:z-[1]">
            ...
            />
            <div
                className="flex relative h-fit  -translate-y-[6%] sm:-translate-y-[10%] xl:-translate-y-[15%] w-full lg:w-[80%] xl:w-[65%] 2xl:w-[55%] items-center justify-center">
                <Image
                    ref={planetsRef}
                    src={event.planet}
                    alt={""}
                ...
                />
                <div
                    className="absolute sm:-top-16 max-w-lg h-full w-3/5 flex flex-col items-center justify-center text-center">
                    <div
                        id="eventName"
                        // style={{
                        //   textShadow:
                        ...
                        // }}
                        className="text-[clamp(20px,4dvw,40px)] vertical-box bg-[#0e1723] py-4 border border-[#666] tracks-box opacity-80 backdrop-blur w-3/4 leading-[1.1] font-anton uppercase font-semibold"
                    >
                        {event?.name}
                    </div>
