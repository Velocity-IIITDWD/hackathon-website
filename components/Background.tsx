const Background = () => {
  return (
    <div className="absolute flex opacity-15 blur-3xl flex-col z-[5] w-full h-full overflow-clip">
      <div className="relative top-[20%] bg-[#304094] w-1/2 md:w-1/4 h-[4%] rounded-full" />
      ...
      <div className="bg-[#304094] w-1/2 md:w-1/4 h-[4%] rounded-full" />
      <div className="bg-[#B745BA] overflow-clip  self-end w-1/2 md:w-1/4 h-[4%] rounded-full" />
      <div className="flex flex-col md:flex-row w-full h-[10%] -rotate-45">
