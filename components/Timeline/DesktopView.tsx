...
export default function DesktopView() {
    return (
        ...
        >
            ...
            <h1
                className="text-3xl sm:text-4xl md:text-5xl font-bold mt-4 z-10 max-md:"
