...
const Cup = ({ prize, cupImage, cupColor, className }: CupProps) => {
  return (
    <div
      className={
        "relative w-[70%] sm:w-3/5 md:w-[30%] lg:w-1/4 xl:w-[17%] py-2 flex flex-col items-center justify-center cup-div before:transition before:duration-300 before:ease-in before:delay-75 hover:before:opacity-70 border-l-2 border-r-2 group " +
        className
      }
    >
      <div
        className={
          "w-full h-full bg-inherit p-4 cup-container grid-lines-bg flex flex-col bg-gradient-carousel items-center justify-center text-2xl md:text-xl lg:text-2xl 2xl:text-3xl " +
          `${cupColor}`
        }
      >
        <Image
