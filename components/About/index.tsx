...
const AboutUs: React.FC = () => {
  ...
  return (
    <div
      id="about"
      className="scroll-mt-10 relative flex flex-col items-center justify-center text-white p-4 px-10"
    >
      <h1
      ...
      <div className="relative max-w-7xl w-full z-10">
        <svg
          className="absolute top-0 left-0 -mt-6 -ml-6 opacity-50"
          width="60"
          height="60"
          viewBox="0 0 97 95"
          fill="none"
        ...
        >
          <path
            d="M1 1V94H16.0456V17.5743H95.8707V1H1Z"
            stroke="#CEB7FF"
            strokeWidth="2"
          />
        </svg>
        ...
        <svg
          className="absolute bottom-0 right-0 -mb-6 -mr-6 opacity-50"
          width="60"
          height="60"
          viewBox="0 0 98 95"
          fill="none"
        ...
        >
          <path
            d="M96.4961 94V1H81.4505V77.4257H1.62543V94H96.4961Z"
            stroke="#CEB7FF"
            strokeWidth="2"
          />
        </svg>
