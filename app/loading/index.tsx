...
function Loader({ rendering }: { rendering?: boolean }) {
  ...
  return (
    <div id="loader" className="z-40 loading-background fixed">
      <div className="z-50 fixed h-screen w-screen backdrop-blur-3xl grid place-items-center">
      ...
      <div className="z-40 fixed w-screen h-screen loading-background background-bg">
